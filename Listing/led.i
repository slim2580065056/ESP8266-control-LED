...
void LED_Set(u8 state)
{
	u16 i;
	u8 s=0;
	if(0==state)	*((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x1000)+12) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x1000)+12) &0xFFFFF)<<5)+(13<<2))))=0;
	else if(1==state)	*((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x1000)+12) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x1000)+12) &0xFFFFF)<<5)+(13<<2))))=1;
	else
	{
		if(++i==state)
			(1==s)?(s=0):(s=1);
		*((volatile unsigned long *)((((((((uint32_t)0x40000000) + 0x10000) + 0x1000)+12) & 0xF0000000)+0x2000000+(((((((uint32_t)0x40000000) + 0x10000) + 0x1000)+12) &0xFFFFF)<<5)+(13<<2))))=s;
	}
}
