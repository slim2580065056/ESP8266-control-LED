...
#line 211 "C:\\My_Program\\001MCU\\Keil_v5\\ARM\\ARMCC\\bin\\..\\include\\stdint.h"
...
#line 275 "C:\\My_Program\\001MCU\\Keil_v5\\ARM\\ARMCC\\bin\\..\\include\\stdint.h"
...
void USART1_IRQHandler(void)
{
	...
	{
		if('0'==(u8)USART_ReceiveData(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)))) {data=1;
		}
		else if('1'==(u8)USART_ReceiveData(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)))){data=0;
		}
...
int fputc(int ch,FILE *f)
{
	...
	while(USART_GetFlagStatus(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)),((uint16_t)0x0080))!=SET);
	return (ch);	
}
...
int fgetc(FILE *f)
{
	...
	while(USART_GetFlagStatus(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)),((uint16_t)0x0020))!=SET);
	return (u32)USART_ReceiveData(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)));
}
