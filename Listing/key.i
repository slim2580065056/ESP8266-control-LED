...
#line 1 "C:\\My_Program\\001MCU\\Keil_v5\\ARM\\ARMCC\\bin\\..\\include\\stdint.h"
...
#line 37 "C:\\My_Program\\001MCU\\Keil_v5\\ARM\\ARMCC\\bin\\..\\include\\stdint.h"
...
#line 208 "C:\\My_Program\\001MCU\\Keil_v5\\ARM\\ARMCC\\bin\\..\\include\\stdint.h"
...
#line 272 "C:\\My_Program\\001MCU\\Keil_v5\\ARM\\ARMCC\\bin\\..\\include\\stdint.h"
...
#line 30 ".\\SYSTEM\\sys.h"

#line 38 ".\\SYSTEM\\sys.h"
...
#line 24 ".\\SYSTEM\\usart.h"
#line 1 "C:\\My_Program\\001MCU\\Keil_v5\\ARM\\ARMCC\\bin\\..\\include\\stdio.h"
...
#line 47 "C:\\My_Program\\001MCU\\Keil_v5\\ARM\\ARMCC\\bin\\..\\include\\stdio.h"
...
#line 138 "C:\\My_Program\\001MCU\\Keil_v5\\ARM\\ARMCC\\bin\\..\\include\\stdio.h"
...
#line 957 "C:\\My_Program\\001MCU\\Keil_v5\\ARM\\ARMCC\\bin\\..\\include\\stdio.h"



 

#line 25 ".\\SYSTEM\\usart.h"
...
#line 9 "APP\\OLED.h"
#line 1 "APP\\SIM_IIC.h"



#line 5 "APP\\SIM_IIC.h"

#line 7 "APP\\SIM_IIC.h"
#line 8 "APP\\SIM_IIC.h"
#line 9 "APP\\SIM_IIC.h"
#line 10 "APP\\SIM_IIC.h"

#line 18 "APP\\SIM_IIC.h"
...
void KEY_GPIO_Config(void)
{
	...
	RCC_APB2PeriphClockCmd(((uint32_t)0x00000004) | ((uint32_t)0x00000008),ENABLE);
...
void KEY_EXTI_Config(void)
{
	...
	GPIO_EXTILineConfig(((uint8_t)0x00), ((uint8_t)0x08));	

	 
	EXTI_InitStructure.EXTI_Line=((uint32_t)0x00001)|((uint32_t)0x00100);	
...
void SET_Screen(void)
{
	switch(SET_Flag)
	{
		case 1:	OLED_Area_Clear();
						...
						OLED_C6X8(48,48,'P');
						OLED_C6X8(56,48,'I');
						OLED_S6X8Num(48,64,SPEED_P,3,1);		
		...
		case 3:	OLED_Area_Clear();
						...
						OLED_C6X8(48,48,'P');
						OLED_C6X8(56,48,'D');
						OLED_S6X8Num(48,64,STAND_P,3,1);		
						OLED_S6X8Num(56,64,STAND_D,3,1);		
			break;
		case 4:
						OLED_C6X8(48,40,' ');
						OLED_C6X8(56,40,'>');
		...
		default:OLED_Area_Clear();		
						...
						OLED_S6X8(40,80,Control[S-1]);			
		
						OLED_S6X8(56,5,"TEMPERATURE");
						OLED_S6X8(56,80,"+22.5");
						OLED_C6X8(56,110,123);		
						OLED_C6X8(56,115,'C');
	}	
}
void BN_Screen(void)
...
void EXTI0_IRQHandler(void)			
{
	...
	{			
		...
		if(GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)),((uint16_t)0x0001))==0)
		{
			...
			if(GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)),((uint16_t)0x0001))==0)
			{				
				while(GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0C00)),((uint16_t)0x0001))==0);	
				BN_Flag++;
				printf("BN_Flag=%d\r\n",BN_Flag);
				BN_Screen();
				GPIO_ReadOutputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), ((uint16_t)0x1000))==1?GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)),((uint16_t)0x1000)):GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)),((uint16_t)0x1000));			
			}
		}		
		EXTI_ClearFlag(((uint32_t)0x00001));		
	}
}
void EXTI9_5_IRQHandler(void)			
{
	if(EXTI_GetITStatus(((uint32_t)0x00100))==SET)
	{			
		if(GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)),((uint16_t)0x0100))==0)
		{
			Delay_ms(20);
			if(GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)),((uint16_t)0x0100))==0)
			{				
				while(GPIO_ReadInputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)),((uint16_t)0x0100))==0);	
				SET_Flag==6?SET_Flag=0,SET_Flag++:SET_Flag++;
				printf("SET_Flag=%d\r\n",SET_Flag);
				SET_Screen();
				GPIO_ReadOutputDataBit(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), ((uint16_t)0x8000))==1?GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)),((uint16_t)0x8000)):GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)),((uint16_t)0x8000));
			}
		}	
		EXTI_ClearFlag(((uint32_t)0x00100));	
	}
}
